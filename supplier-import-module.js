...
(function initSupplierImport(){
  ...
  importButton.textContent = "⇩ Рахунок";
  importButton.type = "button";
  importButton.onclick = () => fileInput.click();

  panelHeadRight.insertBefore(
    importButton,
    document.getElementById("catalogEditButton")
  );
